...
## …: pattern
define-command -params 1.. -docstring %{alignr [<descriptors>]: align the current selection according to command strings passed in arguments
